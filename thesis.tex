...
\chapter{Adaptivität von bestehenden Web Components}
	...
	\begin{figure}[H]		
		...
		\label{img:datTabErg}
	\end{figure}\noindent
	Das Element wurde hier an einen Nutzer angepasst, dessen Präferenzwerte einen erhöhten Kontrast, eine erhöhte Schriftgröße und eine Leserichtung von rechts nach links enthalten. 
	\newpage	
...
_changeFontSize: function () {
   switch (this.fontSize){
	...
	\begin{figure}[H]		
		\centering
		\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{datPicErg.png}
		...
		\label{img:datPicErg}
	\end{figure}\noindent
	Das Element wurde hier an einen Nutzer angepasst, dessen Präferenzwerte eine serife Schriftart, und Text-Alternativen statt Symbole enthalten. 
	\newpage

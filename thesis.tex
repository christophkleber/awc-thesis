...
\begin{document}
	...
	\chapter{Web Components}
		...
		Auf einer aktuellen Übersichtsseite des Konsortiums wird die \emph{Decorators} Technologie nicht mehr erwähnt.\smfootcite[ vgl.][]{WebComCur2016}
		\subsection{Templates}
		\emph{Templates} werden schon über einen längeren Zeitraum in den verschiedenen Browsern unterstützt. Zuallererst wurden sie im \emph{Chrome} im Jahr 2013 verwendet, in der Version 26.\smfootcite[][]{W2015}
...
document.querySelector("body").appendChild(inhalt);
			...
			\ac{CSS} Selektoren können nicht von außerhalb des \emph{Shadow roots} auf dieses Zugreifen und Selektoren, die innerhalb dieses definiert werden haben keinen Einfluss auf den normalen \ac{DOM}.\smfootcite{Bidelman2016}
			\begin{listing}
				\begin{JavaScriptcode*}{}
